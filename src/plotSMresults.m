...
for i = 1:length(variableNames)
   variableNamesSM(i) = {['SM_'+ variableNames(i)+'cm']}; 
   variableNamesST(i) = {['ST_'+ variableNames(i)+'cm']}; 
end
...
simSTTable.ST_10cm = 0.5.*(simSTTable.ST_9cm  + simSMTable.ST_11cm);
simSTTable.ST_20cm = 0.5.*(simSTTable.ST_19cm + simSMTable.ST_21cm);
