function [DataPaths, forcingFileName, durationSize, startDate, endDate, gsOption, phsOption, RunningMessages, ParameterSettingPath] = read_config(config_file)
...
%     end
    ...
    ParameterSettingPath = config_paths{indx};
end