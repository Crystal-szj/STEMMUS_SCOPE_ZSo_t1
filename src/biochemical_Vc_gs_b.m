...
if isfield(biochem_in, 'BallBerry0')
    BallBerry0 = biochem_in.BallBerry0;   % value read from input excel
end
...
switch gsMethod
    case 1  % BallBerry stomatal
        ...
        elseif all(BallBerry0 == 0)
            ...
            Ci = equations.fixedp_brent_ari(@(x) Ci_next_BB(x, Cs, RH, minCi), Cs, [], tol); % [] in place of Gamma: it didn't make much difference
