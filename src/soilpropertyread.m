...
switch sitename
    ...
    case 'CH-HTC'
        SaturatedK=       [70      40     22     22      1      1]./(3600*24);% Saturation hydraulic conductivity (cm.s^-1);
        SaturatedMC=      [0.34    0.36    0.36    0.37    0.37    0.37  ];                              % 0.42 0.55 Saturated water content;
        ResidualMC=       [0.03    0.06    0.06    0.06    0.08    0.08  ];                               %0.037 0.017 0.078 The residual water content of soil;
        Coefficient_n=    [1.3348  1.3100  1.2900  1.2800  1.0900  1.0900 ];                            %1.2839 1.3519 1.2139 Coefficient in VG model;
        Coefficient_Alpha=[0.0085  0.0088  0.0088  0.0088  0.0093  0.0111];                   % 0.02958 0.007383 Coefficient in VG model;
        porosity=         [0.34    0.36   0.36    0.37     0.37    0.37];                                   % Soil porosity;
        fieldMC =         [0.3     0.3    0.3     0.3      0.26    0.26];
