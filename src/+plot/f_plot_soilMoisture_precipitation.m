...
function f = f_plot_soilMoisture(obsDateTime, obsMatrix, simDateTime, simMatrix, simPlotStyle, ybarDatetime, ybar, legendText, ylabelTextL, ylabelTextR, xlimRange, ylimRangeL, ylimRangeR, outputDir,outputName)
...
%     sim = simMatrix(:,1);
    ...
    legend(legendText{1, :},'Precipitation','box','off')
