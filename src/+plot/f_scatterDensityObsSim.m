function f = f_scatterDensityObsSim(obs, sim, ax, xlabelText, ylabelText, outputDir, outputName)
...
f = figure('color','white','units','centimeter','position',[2,2,10.5,8]);
ax = ax;
...
dscatter(obs, sim)  % density scatter
colorbar
